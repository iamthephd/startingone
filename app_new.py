...
def render_selected_cells(file_data):
    ...
    # Buttons in a horizontal layout without nested columns
    st.button("Clear All", key="clear_all", on_click=lambda: clear_selections(file_data), use_container_width=True)
...
def main():
    ...
    if st.session_state.selected_file:
        ...
        with col_a:
            ...
            # Cell Selection
            st.markdown("<h4 style='text-align: center;'>Cell Selection</h4>", unsafe_allow_html=True)
        ...
        with col_b:
            ...
            if st.button("Update Commentary", key=f"update_commentary_btn_{st.session_state.selected_file}"):
                if user_comment:
                    file_data['commentary'] = modify_commentary_llm(
                        user_comment,
                        file_data['selected_cells'],
                        st.session_state.selected_file,
                        st.session_state.contributing_columns,
